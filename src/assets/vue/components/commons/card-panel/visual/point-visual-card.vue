        ...
        <div class="point_card_list">
            <div class="point_card_item" v-for="(vl, i) in breaks" :key="i">
                <div class="point_card_item_icon">
                    <i :class="icon.icon" :style="{'color': current_colors[i] || visualization_colors[i] || visualization_colors[0]}"></i>
                </div>
...
import {visualization_colors, geo_types} from '../../../../../js/constants/Constants'
