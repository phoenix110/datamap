var cityList = {
    ...
    'Z': ['杂多县','赞皇县','枣强县','枣阳市','枣庄','泽库县','增城市','曾都区','泽普县','泽州县','札达县','扎赉特旗','扎兰屯市','扎鲁特旗','扎囊县','张北县','张店区','章贡区','张家港','张家界','张家口','漳平市','漳浦县','章丘市','樟树市','张湾区','彰武县','漳县','张掖','漳州','长子县','湛河区','湛江','站前区','沾益县','诏安县','召陵区','昭平县','肇庆','昭通','赵县','昭阳区','招远市','肇源县',  
